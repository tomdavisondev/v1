...
const About = () => {
  ...
  const skills = ['C#', 'ASP', 'WPF', 'Angular', 'React', 'Node.js'];

  return (
    <StyledAboutSection id="about" ref={revealContainer}>
      <h2 className="formatted-heading">About Me</h2>

      <div className="inner">
        <StyledText>
          <div>
            <p>
              My name is Tom Davison and I enjoy solving problems. 
              I've always enjoyed solving complex problems and programming gives me a vessel to do exactly that.
            </p>
